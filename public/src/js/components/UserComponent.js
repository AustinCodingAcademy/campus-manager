        ...
        <div key={idx} className={'col s12 m6 l4 ' + clearfix}>
          <div className="card">
            <div className="card-content">
              ...
              <br />
              <small><a href="https://chrome.google.com/webstore/detail/aca-desktop-streamer/imnhhcdlfbbhajjgbagfagnjgkmfppcg" onClick={this.showScreenShareModal}><i className="fa fa-info-circle" aria-hidden="true"></i> Enable Screensharing</a></small>
              <br />
              <br />
